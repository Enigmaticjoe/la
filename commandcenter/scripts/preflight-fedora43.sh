...
echo "== Chimera Fedora 43 Preflight =="

echo "[1/5] OS check"
if ! grep -q "Fedora Linux 43" /etc/os-release 2>/dev/null; then
  echo "WARN: This script is tuned for Fedora 43." >&2
fi
...
echo "Preflight complete. Resolve any MISS/IN_USE before deploying the Portainer stack."
