...
echo ""
echo "  3. Wait ~3-5 min for vLLM model load + TEI embedding download, then verify:"
echo "     curl http://localhost:8000/v1/models       # vLLM"
echo "     curl http://localhost:6333/healthz          # Qdrant"
echo "     curl http://localhost:8001/health           # Embeddings"
echo "     curl http://localhost:8888/healthz          # SearXNG"
echo "     curl http://localhost:3000                  # OpenWebUI"
echo ""
